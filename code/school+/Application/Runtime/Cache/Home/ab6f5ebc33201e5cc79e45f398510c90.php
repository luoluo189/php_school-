...
<!-- 商铺列表开始 -->
           <div class="weui_panel weui_panel_access" >
			  <div class="weui_panel_bd">
			    <?php if(is_array($store_information)): $i = 0; $__LIST__ = $store_information;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="dianjia.html" class="weui_media_box weui_media_appmsg">
			      <div class="weui_media_hd" >
			        <img class="weui_media_appmsg_thumb" src="/school+/Public/home/images/shuiguo.jpg" alt="">
			      </div>
