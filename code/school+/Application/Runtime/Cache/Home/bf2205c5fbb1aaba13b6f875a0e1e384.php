...
<div class="weui_tab">
    <div class="weui_tab_bd">
		    ...
		    <!-- 返回图标开始 -->
		    <div   class="back" >
		    <a href="/school+/home/lifa/llist"><img src="/school+/Public/home/images/back.jpg"  style="width:30px;height:30px;" ></a>
		    </div>
        ...
        <div class="line">
            <img src="/school+/Public/home/images/5.png"alt="" style="width:100%;">
            <div class="littletitle" name="set">
                <a class="top" href="/school+/home/lifa/jianjie/si_id/<?php echo ($set["si_id"]); ?>" id="<?php echo ($set["si_id"]); ?>">
                    <div class="ims"><img src="/school+/Public/home/images/51.png" alt=""></div>
                    <div class="f">本店简介</div>
                </a>
                <a class="top" href="/school+/home/lifa/yuyue/si_id/<?php echo ($set["si_id"]); ?>" id="<?php echo ($set["si_id"]); ?>">
                    <div class="ims"><img src="/school+/Public/home/images/52.png" alt=""></div>
                    <div class="f">预约服务</div>
                </a>
                <a class="top" href="/school+/home/lifa/fengping/si_id/<?php echo ($set["si_id"]); ?>" id="<?php echo ($set["si_id"]); ?>" >
                    <div class="ims"><img src="/school+/Public/home/images/53.png" alt=""></div>
        ...
        <div class="weui_tab">
            ...
            <div class="weui_tab_bd">
                <div class="content">
                    ...
                    <div class="t1">
                        <div class="top1" >
                            <div><img src="/school+/Public/home/images/h1.jpg" alt=""></div>
                            <div class="f1">剪发</div>
                        </div>
                        <div class="top2"><p>女士：剪发15元</p></div>
                    </div>
                    <div class="t1">
                        <div class="top1" >
                            <div><img src="/school+/Public/home/images/h1.jpg" alt=""></div>
                        ...
                        <div class="top2"><p>男士：精剪寸头10元</p></div>
                    </div>
                ...
                <div class="content" style="display:none">
                    ...
                    <div class="t1">
                        <div class="top1" >
                            <div><img src="/school+/Public/home/images/h3.jpg" alt=""></div>
                            <div class="f1">烫发</div>
                        </div>
                        <div class="top2"><p>女士：</p></div>
                    </div>
                    <div class="t1">
                        <div class="top1" >
                            <div><img src="/school+/Public/home/images/h3.jpg" alt=""></div>
                ...
                <div class="content" style="display:none">
                    ...
                    <div class="t1">
                        <div class="top1" >
                            <div><img src="/school+/Public/home/images/h2.jpeg" alt=""></div>
                            <div class="f1">染发</div>
                        </div>
                        <div class="top2"><p>女士：</p></div>
                    </div>
                ...
                <div class="content" style="display:none">
                    ...
                    <div class="t1">
                        <div class="top1" >
                            <div><img src="/school+/Public/home/images/h4.jpeg" alt=""></div>
                            <div class="f1">拉直</div>
                        </div>
                        <div class="top2"><p>头发干枯：</p></div>
                    </div>
                    <div class="t1">
                        <div class="top1" >
                            <div><img src="/school+/Public/home/images/h4.jpeg" alt=""></div>
