...
<div class="weui_tab">
    <div class="weui_tab_bd">
        ...
        <div class="weui_panel weui_panel_access">
            <?php if(is_array($store_information)): $i = 0; $__LIST__ = $store_information;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="weui_panel_bd">
                    <a href="<?php echo U('home/dianjia/dianjia');?>" class="weui_media_box weui_media_appmsg">
                        <div class="weui_media_hd">
                            <img class="weui_media_appmsg_thumb"  src="/school+/Public/home/images/guozhi.jpg"  alt="">
                        </div>
