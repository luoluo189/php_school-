...
<div class="weui_tab">
    ...
    <!-- 返回和设置图标开始 -->
		    ...
		    <div class="set">
		   <a href="/school+/home/personal/pset/id/<?php echo ($user["ci_id"]); ?>"><img src="/school+/Public/home/images/set.jpg "   style="width:40px; height:40px;" > </a>
		    </div>
		    </div>
    <!-- 返回和设置图标结束 -->		
    ...
    <!-- 用户头像开始 -->
    <div class="head">
    <img src="/school+/Public/home/images/head.jpg" width="100px" height="100px">
    </div>    
    <div class="user" id="user"><?php echo ($user["ci_name"]); ?></div>
    <!-- 用户头像结束 -->		   
       ...
       <!--导航栏开始-->
        <div class="weui_tab">
            <div class="weui_navbar">
                ...
                <img src="/school+/Public/home/images/qianbao.jpg"   class="qianbao">
                5.5元<br/>
                    我的钱包
                </a>
                ...
                <div class="weui_tab_bd">
                    ...
                    <div class="content" >
                        <div class="weui_cells weui_cells_access">
                            <a class="weui_cell" href="plist.html">
                    ...
                    <div class="content" style="display:none">
                        <div class="weui_cells weui_cells_access">
                            <a class="weui_cell" href="javascript:;">
                                ...
                                <div class="weui_cell_ft">2016.11.19</div>
                            </a>
                            <a class="weui_cell" href="javascript:;">
                                <div class="weui_cell_bd weui_cell_primary">
                                    <p>代金券</p>
                    ...
                    <div class="content" style="display:none">                           
						<div class="weui-row weui-no-gutter">
						  ...
						  <img src="/school+/Public/home/images/youhui.jpg">
						  </div>
						  <div class="weui-col-50">
						  <img src="/school+/Public/home/images/youhui.jpg">
						  </div>
