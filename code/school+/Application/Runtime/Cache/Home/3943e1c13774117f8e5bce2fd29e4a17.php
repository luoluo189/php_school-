...
<div class="weui_tab">
	<div class="weui_tab_bd">
		    ...
		    <!-- 返回图标开始 -->
		    <div   class="back" >
		    <a href="/school+/home/personal/paddress/id/<?php echo ($user["ci_id"]); ?>"><img src="/school+/Public/home/images/back.jpg"  style="width:30px;height:30px;" ></a>
		    </div>
		    <div class="set">
		    新增收货地址
		    </div>
    ...
    <!-- 主体部分开始 -->
        <div class="weui_cells weui_cells_form">
            ...
            <div class="weui_cell">
                ...
                <div class="weui_cell_bd weui_cell_primary">
                    <input class="weui_input" type="tel" placeholder="请输入收货地址">
                </div>
            </div>
