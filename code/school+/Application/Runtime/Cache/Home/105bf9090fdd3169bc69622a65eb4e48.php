...
<div class="weui_tab">
	<div class="weui_tab_bd">
		    ...
		    <!-- 返回图标开始 -->
		    <div   class="back" >
		    <a href="/school+/home/index/index"><img src="/school+/Public/home/images/back.jpg"  style="width:30px;height:30px;" ></a>
		    </div>
		    <div class="set">
		    美发
		    </div>
           ...
           <div class="weui_panel weui_panel_access">
			  ...
			  <?php if(is_array($store)): $i = 0; $__LIST__ = $store;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="/school+/home/lifa/dianpu/si_id/<?php echo ($vo["si_id"]); ?>" class="weui_media_box weui_media_appmsg" id="<?php echo ($vo["si_id"]); ?>">
			      ...
			      <div class="weui_media_bd">
			        ...
			        <p class="weui_media_desc"><?php echo ($vo["si_address"]); ?></p>
			      </div>
