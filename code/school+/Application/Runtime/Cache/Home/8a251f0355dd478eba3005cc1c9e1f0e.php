...
<div class="weui_tab">
    <div class="weui_tab_bd">
            ...
            <!-- 返回图标开始 -->
            <div   class="back" >
            <a href="gouwuche.html"><img src="/school+/Public/home/images/back.jpg"  style="width:30px;height:30px;" ></a>
            </div>
            <div class="set">
            确认订单
            </div>
        ...
        <div  class="user"   style="height:100px;font-size: 18px;">
        <hr/>
        <?php if(is_array($s)): $i = 0; $__LIST__ = $s;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div  style="margin-left: 4%;">

           收货人：<?php echo ($vo['ca_name']); ?> &nbsp;&nbsp;联系电话：<?php echo ($vo['ca_phone']); ?>
            <br/>
            <div  style="margin-top:10px;">

           <img src="/school+/Public/home/images/dingwei.png" style="width:18px; height:30px;float:left;margin-right:20px;">
           <?php echo ($vo['ca_phone']); ?>
           <a href="personal-address.html" ><img src="/school+/Public/home/images/back2.jpg" class="address"></a>
        ...
        <div class="conx">
            <hr/>
            <div class="sto"><input type="checkbox" name="store"/></div>
            <div class="sto1">店铺名称：一个柚子</div>
            <hr/>
            <!--  -->
            <div class="weui_panel_bd">
                <a href="javascript:void(0);" class="weui_media_box weui_media_appmsg">
                    ...
                    <div class="weui_media_bd">
                        <h4 class="weui_media_title">草莓炒酸奶</h4>
                        <p class="weui_media_desc">￥10</p>
                        <p class="weui_media_desc">X1</p>
                    </div>
                    <div  class="as"> <img src="/school+/Public/home/images/chaosuannai.jpg" alt="" class="as1"> </div>
                </a>
        ...
        <div style="margin-left:10px;">
            <input type="radio" name="x"/>自取
            <input type="radio" name="x"/>送货上门
        </div>

        <div class="weui_cells weui_cells_form">
            <div class="weui_cell">
                <div class="weui_cell_bd weui_cell_primary">
                    <textarea class="weui_textarea" placeholder="留言" rows="3"></textarea>
        ...
        <div class="weui_cells">
            <div class="weui_cell">
                ...
                <div class="weui_cell_ft">
                    <a href="javascript:;" class="weui_btn weui_btn_mini weui_btn_primary">提交订单</a>
                </div>
            </div>
        </div>
