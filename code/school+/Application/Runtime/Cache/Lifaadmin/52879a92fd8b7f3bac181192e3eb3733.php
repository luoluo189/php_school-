    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/Lifaadmin/seller/store/id/<?php echo ($store["si_id"]); ?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                             ...
                             <tr>
                                 ...
                                 <td>
                                     <img src="/Public/<?php echo ($store["si_image"]); ?>" alt="<?php echo ($store["si_name"]); ?>的头像" width="150px">
                                 </td>
                             </tr>
