...
<div class="main-wrap">
    ...
    <div class="store-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="">店铺信息</a><span class="crumb-step">&gt;</span></div>
        </div>
        <div class="result-wrap">
        <div class="store-content">
            <ul class="sys-info-list">
                <li>
                    <label class="res-lab">头像</label><span class="res-info"><img src="/Public/<?php echo ($store["si_image"]); ?>" class="res-labb"/></span>
                    <span class="res-labc">
                        <a href="/Lifaadmin/seller/changesellerpic/storePic/<?php echo ($seller["si_id"]); ?>"  class="update"> <input value="修改店铺照片" type="button"></a>
                    </span>
                </li>
                ...
                <li>
                    <a href="/Lifaadmin/seller/changeseller"> <input value="修改店铺信息" type="button"></a>
