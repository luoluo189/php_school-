        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                <ul class="sys-info-list">
                    ...
                    <li>
                        <label class="res-lab">名称</label><span class="res-info"><?php echo ($vo["si_name"]); ?></span>
                        <span class="res-labc"></span>
                    </li>
                    <li>
                        <label class="res-lab">介绍</label><span class="res-info"><?php echo ($vo["si_sintroduce"]); ?></span>
                        <span class="res-labc"></span>
                    </li>
                    <li>
                        <label class="res-lab">所在地址</label><span class="res-info"><?php echo ($vo["si_address"]); ?></span>
                        <span class="res-labc"></span>
                    </li>
                    <li>
