...
<div class="container clearfix">
        ...
        <div class="sidebar-content">
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        <li><a href="seller/"><i class="icon-font">&#xe008;</i>管理店铺信息</a></li>
                        <li><a href="lan/"><i class="icon-font">&#xe004;</i>添加商品栏目</a></li>
                        <li><a href="goods/addgds"><i class="icon-font">&#xe005;</i>上传商品信息</a></li>
                        <li><a href="goods"><i class="icon-font">&#xe006;</i>管理商品信息</a></li>
                        <li><a href="ding/"><i class="icon-font">&#xe012;</i>管理订单信息</a></li>
                    </ul>
                </li>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">管理订单</span></div>
        </div>
