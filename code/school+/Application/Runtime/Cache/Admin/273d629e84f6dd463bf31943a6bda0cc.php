...
<div class="main-wrap">
    ...
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i>
            <a href="/school+/admin/seller/seller">首页</a><span class="crumb-step">&gt;</span>
            <a class="crumb-name" href="/school+/admin/goods/design">商品管理</a>
            <span class="crumb-step">&gt;</span><span>修改商品</span></div>
    </div>
    <div class="result-wrap">
        <div class="result-content">
            <form action="/school+/admin/goods/updategoods/id/<?php echo ($bgoods["bs_gid"]); ?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                <table class="insert-tab" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="common-text required" id="title" name="bs_gname" size="50" value="<?php echo ($bgoods["bs_gname"]); ?>" type="text">
                        </td>
                    </tr>
                    <tr>
                        <th><i class="require-red">*</i>商品型号(颜色)：</th>
                        <td>
                            <input class="common-text required" id="size" name="bs_gsize" size="50" value="<?php echo ($bgoods["bs_gsize"]); ?>" type="text">
                        </td>
                    </tr>
                    <tr>
                        <th><i class="require-red">*</i>商品单价：</th>
                        <td>
                            <input class="common-text required" id="price" name="bs_gprice" size="50" value="<?php echo ($bgoods["bs_gprice"]); ?>" type="text">
                        </td>
                    </tr>
                    <tr>
                        <th><i class="require-red">*</i>商品库存：</th>
                        <td>
                            <input class="common-text required" id="num" name="bs_gnumber" size="50" value="<?php echo ($bgoods["bs_gnumber"]); ?>" type="text">
                        </td>
                    </tr>
                    <tr>
                        <th><i class="require-red">*</i>商品图片：</th>
                        <td><input name="bs_gurl" id="" type="file"><!--<input type="submit" onclick="submitForm('/jscss/school+/admin/design/upload')" value="上传图片"/>--></td>
                    </tr>
                    <tr>
                        <th>商品描述：</th>
                        <td><textarea name="bs_gdescription" class="common-textarea" id="content" cols="30" style="width: 98%;" rows="10"><?php echo ($bgoods["bs_gdescription"]); ?></textarea></td>
                    </tr>
                    <tr>
                        <th></th>
                        <td>
