        ...
        <div class="result-wrap">
            ...
            <div class="result-content">
                ...
                <ul class="sys-info-list" >
                    <li>
                        <label class="res-lab">头像</label><span class="res-info">
                        <img src="/school+/Public/<?php echo ($seller["si_image"]); ?>" class="res-labb"/></span>
                    ...
                    <li>
                        <a href="/school+/admin/seller/changeseller/store?id=<?php echo ($seller["si_id"]); ?>"  class="update"> <input value="修改店铺信息" type="button"></a>
                        <!--href="/admin/seller/changeseller"-->
                    </li>
                </ul>
