...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/jscss/admin/design/">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href=" ">兼职管理</a><span class="crumb-step">&gt;</span><span>添加兼职</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><input class="common-text" name="author" size="50" value="高三物理老师男" type="text"></td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>兼职报酬：</th>
                                <td>
                                    <input class="common-text required" id="title" name="title" size="50" value="1212" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>兼职地址：</th>
                                <td>
                                    <input class="common-text required" id="title" name="title" size="50" value="南二环东路" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>联系人手机号：</th>
                                <td>
                                    <input class="common-text required" id="title" name="title" size="50" value="121324231" type="text">
                                </td>
                            </tr>
                            <tr>
                                <th>兼职内容：</th>
