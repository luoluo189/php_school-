...
//        dump($name);
      ...
      if($storeid==2 ||$storeid ==6){
          ...
          $sql="select distinct appr_id,ci_name ,appr_content, appr_score from appraise,customer_information ,haircut_order_type where   si_iddd=$storeid and customer_information.ci_id=appraise.ci_iddd and haircut_order_type.si_idd=appraise.si_iddd ";
